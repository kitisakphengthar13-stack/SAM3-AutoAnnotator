...
class AppActions(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.run_current = self._action(
            ...
            "sam3",
            "F5",
            "Run SAM3 on the selected image.",
            role="primary",
        )
        ...
        self.pan_tool = self._action(
            ...
            "pan",
            "P",
            "Pan the image without changing annotations.",
            checkable=True,
        )
        self.draw_box = self._action(
            ...
            "draw",
            "B",
            "Draw a bounding box using the active class.",
            checkable=True,
        )
        ...
        self.delete_annotation = self._action(
            ...
            "Delete the selected annotation. Undo restores it.",
            role="danger",
        )
        self.export_dialog = self._action(
            ...
            "export",
            "Ctrl+E",
            "Review export readiness before writing corrected labels.",
            role="export",
        )
        self.export = self._action(
            ...
            "export",
            None,
            "Write corrected labels using the reviewed export plan.",
            role="export",
        )
        ...
        self.fullscreen = self._action(
            ...
            "fullscreen",
            "F11",
            "Toggle fullscreen application mode.",
            checkable=True,
        )
        ...
        self.cancel_batch = self._action(
            ...
            "warning",
            None,
            "Stop after the image currently being processed.",
            role="danger",
        )
    ...
    def _action(
        ...
        *,
        ...
        action.setProperty("iconName", icon_key)
