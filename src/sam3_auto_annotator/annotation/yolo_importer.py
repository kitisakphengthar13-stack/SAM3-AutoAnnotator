...
from sam3_auto_annotator.annotation.geometry import clip_xyxy, validate_image_size
from sam3_auto_annotator.annotation.models import Annotation, AnnotationSource, ImageStatus
...
def import_yolo_detection_labels(project_state, label_dir):
    ...
    prompts = list(project_state.prompts)
