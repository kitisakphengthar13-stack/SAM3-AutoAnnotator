...
QLabel#mutedLabel {{ color: {PALETTE["text_muted"]}; }}
QLabel#validationError {{ color: {PALETTE["danger"]}; }}
QLabel#formLabel {{
    background: transparent;
    border: none;
    color: {PALETTE["text_secondary"]};
...
QPushButton:focus, QToolButton:focus {{ border: 1px solid {PALETTE["primary"]}; }}
...
QLineEdit:hover, QTextEdit:hover, QPlainTextEdit:hover, QComboBox:hover, QDoubleSpinBox:hover {{ border-color: {PALETTE["border"]}; }}
QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus, QComboBox:focus, QDoubleSpinBox:focus {{ border-color: {PALETTE["primary"]}; }}
...
QCheckBox {{ spacing: 7px; color: {PALETTE["text_secondary"]}; }}
QCheckBox:disabled {{ color: {PALETTE["text_disabled"]}; }}
QCheckBox::indicator {{
    width: 16px;
    height: 16px;
...
QCheckBox:focus {{ color: {PALETTE["primary"]}; }}
QCheckBox:focus::indicator {{ border-color: {PALETTE["primary"]}; }}
QLabel#pathDisplay {{
    background: {PALETTE["panel_subtle"]};
    border: 1px solid {PALETTE["border_light"]};
    border-radius: 3px;
...
QWidget#emptyState {{ background: {PALETTE["canvas_bg"]}; color: #d1d5db; }}
QWidget#imageLoadError {{ background: {PALETTE["canvas_bg"]}; }}
QWidget#emptyState QLabel, QWidget#imageLoadError QLabel {{ background: transparent; border: none; }}
QLabel#errorStateTitle, QLabel#emptyTitle {{
    color: #f3f4f6;
    font-size: 12pt;
    font-weight: 700;
}}
QLabel#errorStateDetail, QLabel#emptySubtitle {{ color: #cbd5e1; }}
QPushButton#emptyPrimary, QPushButton#emptySecondary {{
    padding: 6px 11px;
    min-height: 26px;
}}
QPushButton#emptyPrimary {{ background: #172033; border-color: #334155; color: #e5e7eb; }}
QPushButton#emptyPrimary:hover {{ background: #1e293b; border-color: {PALETTE["primary"]}; }}
QPushButton#emptySecondary {{ background: #111827; border-color: #334155; color: #d1d5db; }}
QPushButton#emptySecondary:hover {{ background: #1f2937; border-color: #475569; }}
...
QListView:focus, QTableView:focus {{ border: 1px solid {PALETTE["primary"]}; }}
