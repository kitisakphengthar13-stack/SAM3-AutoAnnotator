...
from sam3_auto_annotator.core.geometry import clip_xyxy, validate_image_size
from sam3_auto_annotator.core import Annotation, AnnotationSource, ImageStatus
